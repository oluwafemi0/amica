...
const PreferencesScreen = () => {
  ...
  const handleSavePreferences = async (filename) => {
    ...
    if (currentUser) {
      ...
      try {
        // Save user details including image filename
        await userDoc.set({
  ...
  return (
    <SafeAreaView style={tw`flex-1 bg-[#fff] `}>
        ...
        <View style={tw`bg-[#332257] p-2  `}>
          <View style={tw`flex-row justify-between items-center mx-auto`}>
            ...
            <View style={tw`flex-1 items-center p-2`}>
              <View style={tw``}>
                <Text style={tw`font-semibold text-lg text-center text-[#fff]`}>Add Your Details</Text>
              </View>
            </View>
          </View>
        </View>
      ...
      <View style={tw`bg-white rounded-lg p-4 `}>
        <Text style={tw`font-medium text-[#333] mb-1 text-left pl-2`}>Name</Text>
        <TextInput
      ...
      <View style={tw`bg-white rounded-lg p-4 `}>
        <Text style={tw`font-medium text-[#333] mb-1 text-left pl-2`}>Location</Text>
        <TextInput
      ...
      <View style={tw`bg-white rounded-lg p-4 `}>
        <Text style={tw`font-medium text-[#333] mb-1 text-left pl-2`}>Description</Text>
        <TextInput
      ...
      <View style={tw`bg-white rounded-lg p-4 `}>
        <Text style={tw`font-medium text-[#333] text-left pl-2 mb-1 `}>Category</Text>
        <TouchableOpacity style={tw`h-12 border border-[#333] rounded-lg justify-center`} onPress={() => setModalVisible(true)}>
          <Text style={tw`text-left pl-2 text-gray-500`}>{categoryName || 'Select Category'}</Text>
        </TouchableOpacity>
      </View>
